...
function uploadAndIdentifyPlantID() {
  ...
  reader.onload = function (e) {
    ...
    const apiKey = 'LCah5GL1UGLN4EmOh5LCfYckgAHORU6lLl8UZApJRxnp7H0HNV';
    ...
    // const apiUrlPlantHealth = 'https://plant.id/api/v3/health_assessment?language=en&details=local_name,description,url,treatment,classification,common_names,cause';
...
function displayPlantIDInfo(plantIdResponse, base64Image){
  ...
  // check to see if the picture the user submitted is not a plant aler the user 
  if (isPlant === false) {
